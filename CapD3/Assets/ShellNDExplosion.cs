...
public class ShellNDExplosion : MonoBehaviour
{
    ...
    public float m_ExplosionForce = 2000f;              // The amount of force added to a tank at the centre of the explosion.
    public float m_MaxLifeTime = 2f;                    // The time in seconds before the shell is removed.
    public float m_ExplosionRadius = 30f;                // The maximum distance away from the explosion tanks can be and are still affected.
