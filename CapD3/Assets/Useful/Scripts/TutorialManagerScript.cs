...
public class TutorialManagerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            ingamecanvascript1.setsentence(8, "");
            Debug.Log(continuing);
        }
    }
}
